...
fun ReaderLoginScreen(
    ...
    Surface(modifier = Modifier.fillMaxSize()) {
        ...
        Row(
            ...
            androidx.compose.material.Text(text = "New User?")
...
fun UserForm(
    ...
    Column(
        ...
        if (isCreateAccount) androidx.compose.material.Text(
...
fun SubmitButton(
    ...
    Button(
        ...
        else androidx.compose.material.Text(text = textId, modifier = Modifier.padding(5.dp))
